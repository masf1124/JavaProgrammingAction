package com.algorithm.redis.chapter4;
...
/**
 * @program: com.algorithm.redis.chapter4
 * @author: mashifei
 * @create: 2019-05-26-20
 */
public class Chapter4 {
    ...
    public Chapter4(String host,int port){
        this.host = host;
        this.port = port;
    }
    ...
    public void testListItem(Jedis conn,boolean nested){
        ...
        System.out.println("We need to set up just enough state so a seller can list a item");
        String seller = "userX";
        String item = "itemX";
        conn.sadd("inventory:"+seller,item);
        Set<String> i = conn.smembers("inventory:"+seller);

        System.out.println("The sellers's inventory has:");
        for(String member:i){
    ...
    public void testPurchaseItem(Jedis conn){
        ...
        System.out.println("We need to set up just enough state so a buyer can buy a item");
        ...
        boolean p = purchaseItem(conn,"userY","itemX","userX",Double.parseDouble("10"));
    ...
    public void testBenchmarkUpdateToken(Jedis conn){
        System.out.println("-------------testBenchmarkUpdateToken---------------");
